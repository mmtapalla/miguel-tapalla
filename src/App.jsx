            ...
            <header className="header">
                ...
                <div className="header__bottom">
                    <ul>
                        <li>
                            <a
                                href="https://github.com/mmtapalla"
                                target="_blank"
